...
class Book(models.Model):
    ...
    book_image = models.ImageField(default="book_imgs\Default Book.jpg", null=True, blank=True, upload_to='book_imgs')
...
class Author(models.Model):
    ...
    author_image = models.ImageField(default="author-imgs\Default Image.jpg",null=True, blank=True, upload_to='author-imgs')
